...
import net.mcreator.spoi.procedures.GainpowerProcedure;
...
public class SolerbaenlBlock extends SpoiModElements.ModElement {
	@ObjectHolder("spoi:solerbaenl")
	public static final Block block = null;
	@ObjectHolder("spoi:solerbaenl")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolerbaenlBlock(SpoiModElements instance) {
		super(instance, 10);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("solerbaenl"));
	}
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("solerbaenl");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				GainpowerProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("solerbaenl");
		}
