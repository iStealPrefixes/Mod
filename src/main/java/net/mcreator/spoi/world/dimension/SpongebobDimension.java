...
package net.mcreator.spoi.world.dimension;
...
import net.mcreator.spoi.procedures.SpongebobPlayerEntersDimensionProcedure;
import net.mcreator.spoi.item.SpongebobItem;
...
public class SpongebobDimension extends SpoiModElements.ModElement {
	@ObjectHolder("spoi:spongebob")
	public static final ModDimension dimension = null;
	@ObjectHolder("spoi:spongebob_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SpongebobDimension(SpoiModElements instance) {
		super(instance, 1);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("spongebob"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("spoi:spongebob")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("spoi:spongebob"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("spoi:spongebob"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpongebobItem().setRegistryName("spongebob"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("spongebob_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = SpongebobDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
				...
				return (this.world.getBlockState(framePos).getBlock() == Blocks.SPONGE.getDefaultState().getBlock()) ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (!(this.world.getBlockState(framePos).getBlock() == Blocks.SPONGE.getDefaultState().getBlock())) {
								break label56;
							}
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("spongebob_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "spongebob_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = SpongebobDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
					...
					for (int i8 = 1; i8 < 3; ++i8) {
						for (int i9 = -1; i9 < 3; ++i9) {
							...
							this.world.setBlockState(blockpos$mutable,
									flag ? Blocks.SPONGE.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Blocks.SPONGE.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		if (event.getTo() == type) {
			{
				...
				SpongebobPlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
